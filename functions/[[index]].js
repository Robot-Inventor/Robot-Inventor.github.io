...
<script>
  (function (w, d, s, i) {
    ...
    function loadAdunit(microadBannerId) {
      w.adunitlength ? w.adunitlength.push('ADU-8CD0H0NJ') : w.adunitlength=['ADU-8CD0H0NJ']; var f=d.getElementsByTagName(s)[0], j=d.createElement(s);
...
<script>
  (function (w, d, s, i) {
    ...
    function loadAdunit(microadBannerId) {
      w.adunitlength ? w.adunitlength.push('ADU-BSBU4LKR') : w.adunitlength=['ADU-BSBU4LKR']; var f=d.getElementsByTagName(s)[0], j=d.createElement(s);
      j.async=true; j.src='https://rise.enhance.co.jp/adu.js?id=' + i + '&matwName=matw_uuid' + '&clientTime=' + (new Date()).getTime() + '&maBannerId=' + microadBannerId;
      f.parentNode.insertBefore(j, f);
    }
