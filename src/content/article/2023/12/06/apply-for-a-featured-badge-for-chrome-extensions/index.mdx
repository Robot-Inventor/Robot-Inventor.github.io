...
modifiedDate: "2023-12-20T20:18:55+09:00"
author: ろぼいん
...
私が開発している拡張機能「[Shadowban Scanner](https://shadowban-scanner.roboin.io/)」にChromeウェブストアの「Featured（おすすめ）バッジ」を申請したので、その手順をまとめます。

「Established Publisher（定評のあるパブリッシャー）バッジ」の申請手順は、別の記事でまとめています。

<ArticleCard link="/article/2023/12/07/apply-for-a-established-publisher-badge-for-chrome-extensions/"/>
...
申請から2週間経ち、申請した「おすすめ」バッジの審査が通ったというメールが届きました。
