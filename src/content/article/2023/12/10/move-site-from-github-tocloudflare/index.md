...
このブログはもともと[GitHub Pages](https://pages.github.com/)でホストしていたのですが、独自ドメインと[Cloudflare Pages](https://pages.cloudflare.com/)に移行したのでその手順をまとめます。
...
私のときは、こういったGitHub PagesからCloudflare Pagesに移行する全体的な流れを解説した記事がなく、右往左往してしまいました。
