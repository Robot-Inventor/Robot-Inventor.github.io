...
2023年9月27日、Windows 11に言語モデルを活用したアシスタント「Microsoft Copilot」が追加されました。このMicrosoft Copilotをタスクバーから消す方法を紹介します。
...
Microsoft Copilotをタスクバーから消すには、タスクバーの何もないところを右クリックし、［タスクバーの設定］を選択します。
